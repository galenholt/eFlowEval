# Function to multiply one stars by another at a different temporal scale, possibly with a lag.
...
unevenTimeMult <- function(fineStars, coarseStars, lag, invertCoarseLogic = FALSE) {
  ...
  # invertLogic asks if we should flip the logicals on the coarse, ie if they are a competitor species
