# Function to intersect raster and polygons and get spatial average and return Simple features

rastPolyJoinSFout <- function(polysf, rastst, grouper = 'SYS2', maintainPolys = TRUE) {
