...
#SBATCH --time=00:01:00 # request time (walltime, not compute time)
...
Rscript hpc_wrap.R "Scripts/DataProcessing/testingandscratch/argtest" "volInun" ${SLURM_ARRAY_TASK_ID} "Lachlan"
