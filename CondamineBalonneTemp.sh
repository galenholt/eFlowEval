...
#SBATCH --time=0:10:00 # request time (walltime, not compute time)
...
Rscript hpc_wrap.R "Scripts/DataProcessing/processTempSubChunk.R" "weightedMean" ${SLURM_ARRAY_TASK_ID} "CondamineBalonne"
