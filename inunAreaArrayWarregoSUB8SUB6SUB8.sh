...
#SBATCH --time=24:00:00 # request time (walltime, not compute time)
...
Rscript hpc_wrap.R "Scripts/DataProcessing/processInundationSubChunk.R" "areaInun" ${SLURM_ARRAY_TASK_ID} "Warrego" "8" "6" "8"
