...
#SBATCH --time=48:00:00 # request time (walltime, not compute time)
#SBATCH --mem=512GB # request memory
...
Rscript hpc_wrap.R "Scripts/DataProcessing/testingandscratch/memTiming.R" "areaInun" ${SLURM_ARRAY_TASK_ID} "CondamineBalonne"
