...
```{r}
processData(dataname = datname, data_dir = datDir, summaryFun = sumFun, out_dir = datOut, catchment = catch, thischunk = chunk, subchunkArgs = suba)
```
...
processData(dataname = datname, data_dir = datDir, summaryFun = sumFun, out_dir = datOut, catchment = catch, thischunk = chunk, subchunkArgs = suba, rastRollArgs = rra)
```
