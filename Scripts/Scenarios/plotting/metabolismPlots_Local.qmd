...
(tempyrC + ggtitle('Baseline temperature') + theme(legend.position = 'none')) +
  (climyrC + ggtitle('2c warming') + theme(legend.position = 'none')) +
  
  (inunyrC + ggtitle('Baseline inundation') + theme(legend.position = 'none')) +
(gppBaseC) + # + ggtitle('Baseline') 
  (gppClimC + theme(legend.position = 'none')) + #  + ggtitle('2c warming')
  
  (inun10pyrC + ggtitle('110% inundation') + theme(legend.position = 'none')) +
  (gpp10pC + theme(legend.position = 'none')) + # + ggtitle('110% inundation') 
  (gpp10p_climC + theme(legend.position = 'none')) + # + ggtitle('2c & 110%')
