...
```{r}
inun5label <- 'Maximum inundation\n2014-2019 (Gl)'
temp5label <- 'Mean temp\n2014-2019 (C)'
gpp5label <- 'Maximum GPP\n2014-2019 (tonnes O2)'
er5label <- 'Maximum ER\n2014-2019 (tonnes O2)'
```
...
```{r}
inunyrsAll <- inunfun(inundationannual/1000, 1, datewanted = as.character(availDays), 
               units = 'tonnes', 
               plotPkg = 'ggplot', 
               titled = FALSE, 
               titlePrefix = 'Water year beginning ',
...
gppyrsAll <- gppfun(logGPPdaysannual/1000, 1, datewanted = as.character(availDays), 
               units = 'tonnes', 
               plotPkg = 'ggplot', 
               titled = FALSE, 
               titlePrefix = 'Water year beginning ',
...
timemapsandseries <- (inunyrsAll +
  ...
  theme(legend.position = 'right', 
       legend.background = element_blank(),
       legend.key.size = unit(0.3, 'cm')) +
  xlim(c(as.Date('2015-03-01'), as.Date('2019-09-01')))) 
