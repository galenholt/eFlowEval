...
registerDoFuture()
plan(multisession) # On windows
benchmultisession <- microbenchmark::microbenchmark("t2557a10" = { b <- timeinun(ntimes = 100, nanaes = 10)},
                                           "t2557a100" = { b <- timeinunP(ntimes = 10, nanaes = 100)},
                                           # "t2557a1000" = { b <- timeinunP(ntimes = 10, nanaes = 1000)},
                                           times = 1)
...
benchmulticore <- microbenchmark::microbenchmark("t2557a10" = { b <- timeinun(ntimes = 100, nanaes = 10)},
                                                    "t2557a100" = { b <- timeinunP(ntimes = 10, nanaes = 100)},
                                                    # "t2557a1000" = { b <- timeinunP(ntimes = 10, nanaes = 1000)},
                                                    times = 1)
...
benchbatch <- microbenchmark::microbenchmark("t2557a10" = { b <- timeinun(ntimes = 100, nanaes = 10)},
                                                 "t2557a100" = { b <- timeinunP(ntimes = 10, nanaes = 100)},
                                                 # "t2557a1000" = { b <- timeinunP(ntimes = 10, nanaes = 1000)},
                                                 times = 1)
