# script to process the temps for a 2C warming scenario and process into anaes

# basically the same as processTempSubChumk but with a 2C increase
...
scriptOut <- paste0(datOut, '/Climateprocessed/', summaryFun, '/chunked/', 
